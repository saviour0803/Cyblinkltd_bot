...
BOT_TOKEN = os.environ '8214837266:AAHLVEX-Ery4jd5w'
VERIFICATION_API_URL = os.environ 'https://api
API_KEY = os.environ 6be46ef9b14c1ca3e7'
CHANNEL_ID = os.environ '-10
